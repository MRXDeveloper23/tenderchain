        ...
        <div className="">
          <div className="btn-group m-3 ">
            <input
              type="radio"
              name="options"
              data-title="OpenTender"
              className="btn w-[150px]"
              onClick={selectOpenTender}
            />
            <input
              type="radio"
              name="options"
              data-title="SelectiveTender"
              className="btn"
              onClick={selectSelectiveTender}
            />
          </div>
          ...
          <div className="items-center m-3">
            <h1 className="ml-4 mb-2 text-lg font-semibold">
              Tender Description
            </h1>
            <input
              type="text"
          ...
          <div className="flex justify-center">
            <button
              className="btn bg-base-100 hover:bg-primary"
